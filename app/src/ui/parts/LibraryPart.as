...
public class LibraryPart extends UIPart {
	...
	private const bgColor:int = 0xFFFFFF;//color of libry, sprite area
	...
	private function fixLayout():void {
		...
		paintButton.x = 380 + 19;                            // width of libraryOff.png sprite
		if (app.stageIsContracted) paintButton.x = 138 + 19; // width of libraryOff.png sprite
		paintButton.y = buttonY + 0;
		...
		newSpriteLabel.x = paintButton.x - newSpriteLabel.width - 6;
		newSpriteLabel.y = 6;
