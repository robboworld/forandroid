...
public class ImagesPart extends UIPart {
	...
	private function addNewCostumeButtons():void {
		...
		addChild(paintButton = makeButton(paintCostume, 'paintbrush', left + 1, buttonY - 1));
		addChild(importButton = makeButton(costumeFromComputer, 'import', left + 22, buttonY - 2));
		addChild(cameraButton = makeButton(costumeFromCamera, 'camera', left + 50, buttonY));
	}
