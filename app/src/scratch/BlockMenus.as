...
public class BlockMenus implements DragClient {
	...
	public static function BlockMenuHandler(evt:MouseEvent, block:Block, blockArg:BlockArg = null, menuName:String = null):void {
		...
		if (menuName == 'analog') menuHandler.analogMenu(evt);
	}
...
//			handler.scrollAlignMenu(evt);
	...
	private function motorDirectionMenu(evt:MouseEvent):void {
		var ops:Array = ['this way', 'that way', 'left', 'right'];
	...
	private function analogMenu(evt:MouseEvent):void {
		var m:Menu = new Menu(setBlockArg, 'analog');
		m.addItem('Analog 0');
		m.addItem('Analog 1');
		m.addItem('Analog 2');
		m.addItem('Analog 3');
