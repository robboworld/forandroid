...
public class Server implements IServer {
	...
	public function fetchLocalAsset(file:String, whenDone:Function):void {
		var ret:ByteArray = Resources.load(file);
		if (ret != null)
			whenDone(ret);
	}
...
//		}
	...
	public function getLanguageList(whenDone:Function):void {
		//fetchAsset('locale/lang_list.txt', whenDone); commented by me
		fetchLocalAsset("langList", whenDone);
	}

	public function getPOFile(lang:String, whenDone:Function):void {
		//fetchAsset('locale/' + lang + '.po', whenDone); commented by me
		fetchLocalAsset("lang" + lang.toUpperCase(), whenDone);
	}
