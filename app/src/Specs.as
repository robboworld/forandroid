...
public class Specs {
	...
	public static var commands:Array = [
		...
		["-"],
		["turn motor on for %n secs",			" ", 1, "motorOnFor:elapsed:from:",                   1],
		...
		["motor on",						    " ", 101, "allMotorsOn"],
		["motor off",							" ", 101, "allMotorsOff"],
		["motor direction %m.motorDirection",   " ", 101, "setMotorDirection:",          "this way"],
		...
		["%m.analog",                           "r", 107,  "sensor:",            "Analog 0"],
	...
	public static var extensionSpecs:Array = ["when %m.booleanSensor", "when %m.sensor %m.lessMore %n", 
		"sensor %m.booleanSensor?", "%m.sensor sensor value", 
		"turn %m.motor on for %n secs", "turn %m.motor on", 
		"turn %m.motor off", "set %m.motor power to %n", "set %m.motor2 direction to %m.motorDirection", 
		"when distance %m.lessMore %n", "when tilt %m.eNe %n", "distance", "tilt"];
